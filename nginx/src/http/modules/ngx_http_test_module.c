...
static char *ngx_http_test(ngx_conf_t *, ngx_command_t *, void *);
static ngx_int_t ngx_http_test_handler(ngx_http_request_t *);
...
ngx_http_test(ngx_conf_t *cf, ngx_command_t *cmd, void *conf) {
      ...
      corecf->handler = ngx_http_test_handler;
      return NGX_CONF_OK;
};

static ngx_int_t ngx_http_test_handler(ngx_http_request_t *req) {
      u_char html[1024] = "<h1>This is Test Page!Ohhhhhhhhhhhhhhh</h1>";
